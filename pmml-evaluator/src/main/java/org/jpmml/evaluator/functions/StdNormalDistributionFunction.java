...
abstract
public class StdNormalDistributionFunction extends UnaryFunction {

	public StdNormalDistributionFunction(String name){
		super(name, Arrays.asList("x"));
	}
	...
	public FieldValue evaluate(FieldValue first){
		...
		NormalDistribution distribution = new NormalDistribution(0d, 1d);
