...
public class SparseRegressionModelEvaluator extends SparseModelEvaluator<RegressionModel> {

	public SparseRegressionModelEvaluator(PMML pmml, SparseEvaluatorConfig sparseEvaluatorConfig){
		super(pmml, PMMLUtil.findModel(pmml, RegressionModel.class), sparseEvaluatorConfig);
	}

	public SparseRegressionModelEvaluator(PMML pmml, RegressionModel regressionModel, SparseEvaluatorConfig sparseEvaluatorConfig){
		super(pmml, regressionModel, sparseEvaluatorConfig);
	...
	private <V extends Number> Value<V> evaluateRegressionTable(ValueFactory<V> valueFactory, RegressionTable regressionTable, EvaluationContext context){
		...
		if(regressionTable.hasNumericPredictors()){
			...
			for(NumericPredictor numericPredictor : numericPredictors){
				...
				if (!fieldPresentCache.getOrDefault(name, sparseEvaluatorConfig.getDefaultInclusion())) {
					continue;
				}
