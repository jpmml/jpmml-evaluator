...
public interface PMMLAttributes {
	...
	Field BINARYSIMILARITY_C00PARAMETER = ReflectionUtil.getField(BinarySimilarity.class, "c00Parameter");
	Field BINARYSIMILARITY_C01PARAMETER = ReflectionUtil.getField(BinarySimilarity.class, "c01Parameter");
	Field BINARYSIMILARITY_C10PARAMETER = ReflectionUtil.getField(BinarySimilarity.class, "c10Parameter");
	Field BINARYSIMILARITY_C11PARAMETER = ReflectionUtil.getField(BinarySimilarity.class, "c11Parameter");
	Field BINARYSIMILARITY_D00PARAMETER = ReflectionUtil.getField(BinarySimilarity.class, "d00Parameter");
	Field BINARYSIMILARITY_D01PARAMETER = ReflectionUtil.getField(BinarySimilarity.class, "d01Parameter");
	Field BINARYSIMILARITY_D10PARAMETER = ReflectionUtil.getField(BinarySimilarity.class, "d10Parameter");
	Field BINARYSIMILARITY_D11PARAMETER = ReflectionUtil.getField(BinarySimilarity.class, "d11Parameter");
	...
	Field GAUSSIANDISTRIBUTION_MEAN = ReflectionUtil.getField(GaussianDistribution.class, "mean");
	Field GAUSSIANDISTRIBUTION_VARIANCE = ReflectionUtil.getField(GaussianDistribution.class, "variance");
	...
	Field LINEARNORM_NORM = ReflectionUtil.getField(LinearNorm.class, "norm");
	Field LINEARNORM_ORIG = ReflectionUtil.getField(LinearNorm.class, "orig");
	...
	Field OUTPUTFIELD_NAME = ReflectionUtil.getField(OutputField.class, "name");
	...
	Field POISSONDISTRIBUTION_MEAN = ReflectionUtil.getField(PoissonDistribution.class, "mean");
	...
	Field SCOREDISTRIBUTION_RECORDCOUNT = ReflectionUtil.getField(ScoreDistribution.class, "recordCount");
	Field SCOREDISTRIBUTION_VALUE = ReflectionUtil.getField(ScoreDistribution.class, "value");
