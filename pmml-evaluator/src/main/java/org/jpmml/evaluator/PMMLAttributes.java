...
public interface PMMLAttributes {
	...
	Field BAYESINPUT_FIELDNAME = ReflectionUtil.getField(BayesInput.class, "fieldName");
	Field BAYESOUTPUT_FIELDNAME = ReflectionUtil.getField(BayesOutput.class, "fieldName");
	...
	Field CATEGORICALPREDICTOR_NAME = ReflectionUtil.getField(CategoricalPredictor.class, "name");
	...
	Field NUMERICPREDICTOR_NAME = ReflectionUtil.getField(NumericPredictor.class, "name");
	...
	Field PPCELL_PREDICTORNAME = ReflectionUtil.getField(PPCell.class, "predictorName");
